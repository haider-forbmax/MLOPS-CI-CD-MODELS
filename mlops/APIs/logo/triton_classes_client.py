...
Usage:
  python triton_classes_client.py --url 192.168.18.30:3087 --model yolo11n-logo
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Inspect Triton model metadata/classes for logo model.")
    parser.add_argument("--url", default="192.168.18.30:3087", help="Triton HTTP URL in host:port format")
    parser.add_argument("--model", default="yolo11n-logo", help="Model name")
