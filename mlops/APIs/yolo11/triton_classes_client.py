#!/usr/bin/env python3
"""
Standalone Triton client utility to inspect model parameters/metadata and extract classes.

Usage:
  python triton_classes_client.py --url 192.168.18.30:3087 --model yolo11
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Inspect Triton model metadata/classes.")
    parser.add_argument("--url", default="192.168.18.30:3087", help="Triton HTTP URL in host:port format")
    parser.add_argument("--model", default="yolo11", help="Model name")
